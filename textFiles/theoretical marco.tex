...
% Esta etiqueta la elimine de aquí, usialemnte no se ponen etiquetas de estar forma, si no, directamente dentre de una figura, al inmediatamante que se hace una sección o capítulo, ecuciones más pequeñas com oestas no ahce falta ponerla. Si enumeramos ecuaciones ahí si, para más adelante hacer referencia a ellas.
%\label{sec: one neuron}.
        ...
        \begin{figure}[H]
            ...
            \begin{subfigure}[H]{0.49\textwidth}
                ...
                \label{fig:f2}  % Aquí no les recomeindo poner la etiquta de fig2 porque no dice nada, y cuando tengan 50 figuras no van a saber cual es cual, mejor ponganle un nombre alusivo a lo que es la etiqueta
            \end{subfigure}
...
Así, las neuronas de color azul cuentan con una funci\'on (puede ser sigmoidal, escalonada, entre otras), 
        ...
        \subsection{Algoritmo Backpropagation}
        	...
        	El bacpkpropagation es un algoritmo de aprendizaje que permite el aprendizaje de la red,
            permite que una red neuronal pueda auto-ajustar todos sus parámetros para aprender una representaci\'on 
