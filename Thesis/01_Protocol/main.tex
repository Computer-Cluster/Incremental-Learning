...
=======
% Paquete principal de TikZ
\usepackage{tikz}

% Librerías útiles para diagramas de flujo
\usetikzlibrary{arrows.meta}      % Para personalizar flechas
\usetikzlibrary{shapes.geometric} % Para formas (rectángulos, círculos, etc.)
\usetikzlibrary{positioning}      % Para colocar nodos relativos
\usetikzlibrary{fit}              % Para agrupar nodos
\usetikzlibrary{calc}             % Para cálculos de posiciones
>>>>>>> 722d1cb ([FEAT]: add a new version of the PRISMA metodology)
