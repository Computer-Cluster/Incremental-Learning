...
El propósito fue identificar y analizar investigaciones relevantes relacionadas con el aprendizaje incremental y sus aplicaciones dentro del campo de la Inteligencia Artificial. \\
...
Se utilizaron combinaciones booleanas de palabras clave en inglés y español, entre las cuales se incluyeron: 
...
Los términos fueron ajustados a las opciones de búsqueda de cada base de datos para maximizar la cobertura de resultados relevantes.

\subsubsection{Criterios de Inclusión y Exclusión}
Con el fin de garantizar la pertinencia y calidad metodológica de los estudios seleccionados, se establecieron los siguientes criterios:

\textbf{Criterios de inclusión:}
\begin{itemize}
    \item Publicaciones comprendidas entre 2017 y 2024.
    \item Artículos que aborden explícitamente el aprendizaje incremental o aprendizaje continuo en redes neuronales artificiales.
    \item Investigaciones que analicen el fenómeno de \textit{catastrophic forgetting} o presenten soluciones asociadas.
    \item Estudios con aplicaciones en áreas prácticas como robótica, visión por computadora, ciberseguridad o sistemas adaptativos.
\end{itemize}
...
Durante la fase de cribado (revisión de títulos y resúmenes), se excluyeron 886 estudios por no cumplir los criterios de inclusión. Los 48 artículos restantes fueron evaluados a texto completo, y finalmente, 18 cumplieron con los estándares metodológicos y temáticos requeridos para la síntesis cualitativa. \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l c}
        ...
        \midrule
        Registros identificados en bases de datos \& 1,246 \\
        Duplicados eliminados \& 312 \\
        Registros tras eliminación de duplicados \& 934 \\
        Registros excluidos tras revisión de título/resumen \& 886 \\
        Artículos evaluados a texto completo\& 48 \\
        Artículos excluidos por falta de resultados aplicables \& 30 \\
...
Los 18 estudios incluidos ofrecen una visión integral del aprendizaje incremental en redes neuronales artificiales desde diferentes enfoques y dominios de aplicación. Las principales líneas temáticas identificadas fueron:
...
\begin{itemize}
    ...
    \item \textbf{Métodos Generales:} propuestas basadas en regularización elástica \cite{kirkpatrick2017}, memoria episódica \cite{rebuffi2017}, y arquitecturas dinámicas con expansión neuronal progresiva \cite{parisi2019,bullinaria2008}.
\end{itemize}

En conjunto, la evidencia revisada demuestra un progreso sustancial en el desarrollo de modelos capaces de aprender de manera continua. No obstante, persisten desafíos relacionados con la escalabilidad, el costo computacional y el equilibrio entre estabilidad y plasticidad. Estos hallazgos refuerzan la necesidad de investigaciones orientadas a optimizar el aprendizaje incremental en entornos reales y con datos no estacionarios.
