...
\begin{document}
   ...
   %% \thispagestyle{empty}
    ...
    \include{textFiles/objectives}
    \include{textFiles/researchQuestion}
    \include{textFiles/justification}
    \include{textFiles/delimitation}
    
    \include{textFiles/literatureReview}
    \include{textFiles/methodology}
    \include{textFiles/findings}
    \include{textFiles/capitulated}
    \include{textFiles/timeline}
